#ifndef src__slash__asm_disasm_visitor_base_class_hpp
#define src__slash__asm_disasm_visitor_base_class_hpp
...
#endif		// src__slash__asm_disasm_visitor_base_class_hpp
